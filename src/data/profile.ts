export const profile = {
  ...
  languages: ["English (Native/Bilingual)", "Hindi (Native/Bilingual)", "Urdu (Native/Bilingual)"],
  education: [
    { degree: "Bachelor's in Computer Science", school: "Karakarum International University", period: "2021-2025" },
    { degree: "Intermediate (Computer Science)", school: "GCCES", period: "2019-2021" },
    { degree: "Matriculation (Computer Science)", school: "D. J High School Gilgit", period: "2017-2019" },
  ],
  social: {
...
export const skills = {
  "AI/ML/NLP": ["Python", "TensorFlow", "PyTorch", "Scikit-learn", "HuggingFace", "NLP"],
  "Generative AI": ["OpenAI", "Claude", "LLM Agents", "LangChain", "RAG Systems"],
...
export const experience = [
  ...
  },
  {
    ...
    company: "Upwork",
    period: "2023 - Present",
    description: "Top Rated freelancer with $4K+ earnings. Built enterprise SaaS applications, AI research agents, and automation systems for global clients.",
  }
]
...
export const testimonials = [
  ...
  {
    quote: "An amazing, cooperative, and skilled individual. Committed to his knowledge, punctual in delivery. I enjoyed working with him and look forward to collaborating again.",
    author: "Yazan Shannek",
    role: "Python Project",
    rating: 5.0,
    amount: "$15.00",
  },
